            ...
            <div class="col-md-7">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <?php else: ?>
                            <div class="car-image w-100 mb-3 bg-light d-flex align-items-center justify-content-center rounded">
                ...
                <div class="sticky-sidebar">
                    ...
                    <div class="card message-box">
                        <div class="card-body">
                            ...
                            <form method="POST">
                                <div class="mb-3">
                                    <textarea name="pesan" class="form-control" rows="3" placeholder="Halo, saya tertarik dengan mobil ini. Bisa beri informasi lebih lanjut?" required></textarea>
                                </div>
